...
import CreateNewAPIGroup from './pages/createNewAPIGroup';
import ViewAPIGroup from './pages/viewAPIGroup';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/viewAPIGroup/:groupName" element={<ViewAPIGroup />} />
        ...
        <Route path="/createNewAPIGroup" element={<CreateNewAPIGroup />} />
